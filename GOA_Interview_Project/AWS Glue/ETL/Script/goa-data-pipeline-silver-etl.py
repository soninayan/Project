...
# Script generated for node Change Schema
ChangeSchema_node1779690484957 = ApplyMapping.apply(frame=SelectFromCollection_node1779689410632, mappings=[("origin", "string", "origin", "string"), ("destination", "string", "destination", "string"), ("start_odometer", "long", "start_odometer", "bigint"), ("end_odometer", "long", "end_odometer", "bigint"), ("distance_km", "long", "distance_km", "bigint"), ("reading_date", "string", "reading_date", "date")], transformation_ctx="ChangeSchema_node1779690484957")
...
FROM distance_log
'''
SQLQuery_node1779671769309 = sparkSqlQuery(glueContext, query = SqlQuery22, mapping = {"distance_log":ChangeSchema_node1779690484957}, transformation_ctx = "SQLQuery_node1779671769309")
...
AmazonS3_node1779673231530 = glueContext.write_dynamic_frame.from_options(frame=SQLQuery_node1779671769309, connection_type="s3", format="glueparquet", connection_options={"path": "s3://goa-data-pipeline-silver-ap-ca-central-1-lab/Parquet/", "partitionKeys": []}, format_options={"compression": "snappy"}, transformation_ctx="AmazonS3_node1779673231530")
